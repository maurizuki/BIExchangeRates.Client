...
The console application [BIExchangeRates.Console](https://github.com/maurizuki/BIExchangeRates.Client/tree/v1.3.0/src/BIExchangeRates.Console) is intended as an example on how to use the REST API wrapper in a real scenario.
...
* [BIExchangeRates.Client API Reference](https://github.com/maurizuki/BIExchangeRates.Client/blob/v1.3.0/docs/BIExchangeRates.Client.md)
